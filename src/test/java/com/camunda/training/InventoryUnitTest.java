...
public class InventoryUnitTest {
  ...
  public void happy_path_test() {
    ...
    ProcessInstance processInstance = runtimeService().startProcessInstanceByKey(INVENTORY_PROCESS_ID,
        withVariables(ORDER_ITEMS_NUM_VAR, 5, AVAILABLE_ITEMS_NUM_VAR, 4));

    assertThat(processInstance).isWaitingAt(findId(RESERVE_AVAILABLE_ITEMS_TASK)).externalTask()
        .hasTopicName(AVAILABILITY_CHECK_TOPIC);
